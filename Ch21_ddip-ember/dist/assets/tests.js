...
define('ddip-ember/tests/integration/components/entity-list-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Component | entity-list', function (hooks) {
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "dX8ijF3D",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"entity-list\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "qh90Ns1C",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"entity-list\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('ddip-ember/tests/lint/app.lint-test', [], function () {
  'use strict';
  ...
  QUnit.test('components/entity-list.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/entity-list.js should pass ESLint\n\n');
  });

  QUnit.test('models/node--article.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'models/node--article.js should pass ESLint\n\n');
  });

  QUnit.test('models/node--page.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'models/node--page.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('routes/pages.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/pages.js should pass ESLint\n\n');
  });
});
define('ddip-ember/tests/lint/templates.template.lint-test', [], function () {
  'use strict';

  QUnit.module('TemplateLint');

  QUnit.test('ddip-ember/templates/application.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'ddip-ember/templates/application.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('ddip-ember/templates/articles.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'ddip-ember/templates/articles.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('ddip-ember/templates/components/entity-list.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'ddip-ember/templates/components/entity-list.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('ddip-ember/templates/pages.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'ddip-ember/templates/pages.hbs should pass TemplateLint.\n\n');
  });
});
define('ddip-ember/tests/lint/tests.lint-test', [], function () {
  'use strict';

  QUnit.module('ESLint | tests');

  QUnit.test('integration/components/entity-list-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/entity-list-test.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('unit/models/node--article-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/models/node--article-test.js should pass ESLint\n\n');
  });

  QUnit.test('unit/models/node--page-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/models/node--page-test.js should pass ESLint\n\n');
  });

  QUnit.test('unit/routes/articles-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/articles-test.js should pass ESLint\n\n');
  });

  QUnit.test('unit/routes/pages-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/pages-test.js should pass ESLint\n\n');
  });
});
...
define('ddip-ember/tests/test-helper', ['ddip-ember/app', 'ddip-ember/config/environment', '@ember/test-helpers', 'ember-qunit'], function (_app, _environment, _testHelpers, _emberQunit) {
  'use strict';
...
define('ddip-ember/tests/unit/adapters/application-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
...
define('ddip-ember/tests/unit/models/node--article-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Model | node  article', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);

    // Replace this with your real tests.
    (0, _qunit.test)('it exists', function (assert) {
      let store = this.owner.lookup('service:store');
      let model = store.createRecord('node--article', {});
      assert.ok(model);
    });
  });
});
define('ddip-ember/tests/unit/models/node--page-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Model | node  page', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);

    // Replace this with your real tests.
    (0, _qunit.test)('it exists', function (assert) {
      let store = this.owner.lookup('service:store');
      let model = store.createRecord('node--page', {});
      assert.ok(model);
    });
  });
});
define('ddip-ember/tests/unit/routes/articles-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Route | articles', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
...
define('ddip-ember/tests/unit/routes/pages-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Route | pages', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);

    (0, _qunit.test)('it exists', function (assert) {
      let route = this.owner.lookup('route:pages');
      assert.ok(route);
    });
  });
});
...
require('ddip-ember/tests/test-helper');
